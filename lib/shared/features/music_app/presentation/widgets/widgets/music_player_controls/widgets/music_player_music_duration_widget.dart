...
import 'package:dropz_app/core/extensions/duration_extension.dart';
...
class MusicPlayerMusicDurationWidget extends StatefulWidget {
  final int duration;
  const MusicPlayerMusicDurationWidget({required this.duration, super.key});
      ...
      builder: (context, AsyncSnapshot<Duration> snapshot) {
        ...
        return Column(
          children: [
            Obx(
              () => Slider(
                value: (sliderValueRx.value ?? seconds / widget.duration).clamp(
                  0,
                  1,
                ),
